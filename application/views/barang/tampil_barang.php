    ...
    <div class="flex justify-center m-5">
        ...
        <div class="mx-20 text-white">
            <table id="table_id" class="table table-striped ">
                <thead>
                    <tr>
                        <th class="border text-white">ID Barang</th>
                        <th class="border text-white">Nama Barang</th>
                        <th class="border text-white">Jenis Barang</th>
                        <th class="border text-white">Stok</th>
                        <th class="border text-white">Harga</th>
                    ...
                    <?php foreach ($barang as $s) : ?>
                        <tr>
                            ...
                            <td class="border text-white">
                                <a class="bg-blue-800 rounded-lg p-2 hover:bg-blue-500 text-white" href="<?php echo site_url('barang/ubah/' . $s->id_barang) ?>">Ubah</a>
                                <a class="bg-blue-800 rounded-lg p-2 hover:bg-blue-500 text-white" href="<?php echo site_url('barang/hapus/' . $s->id_barang) ?>">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                <div class="mb-3 text-white">
                <a href="<?php echo site_url('barang/simpan') ?>" class="bg-blue-800 rounded-lg p-2 hover:bg-blue-500 text-white">Tambah Data</a>
            </div>
            </table>
        </div>
