            ...
            <div class="container flex flex-row justify-between items-center py-48 ml-24">
                <div class="w-[32%] flex flex-col space-y-12">
                    ...
                    <div class="flex items-center" data-aos="fade-right" data-aos-duration="1000">
                        <div class="w-3/5 z-10">
                            <a href="<?= base_url('images/nivea-deep.png') ?>" class="relative inline bg-[#2b2b2b] font-semibold text-lg py-3 px-10 rounded-lg capitalize shadow-one hover:bg-[#fff] hover:text-gray-800 group" target="_blank">
                ...
                <div class="w-[30%] flex flex-col items-center">
                    ...
                    <div class="w-full h-[440px] mt-4 hover:scale-105 transition-all">
                        <img src="<?= base_url('assets/images/nivea-deep.png') ?>" class="w-96 h-full-object-cover drop-shadow-one z-10" alt="Main Product">
                    </div>
                </div>
