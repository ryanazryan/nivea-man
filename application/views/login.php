...
<body style="background: linear-gradient(90deg, #413f42 50%, #000 50%);">
    <div class="cont">
        ...
        <div class="form sign-in" style="background: #413f42;">
            ...
            <form action="<?= base_url('user/login') ?>" method="post">
                ...
                <input class="submit" type="submit" value="LOGIN" style="margin-left: 240px;"></input>
            </form>
                <?= validation_errors(); ?>
        </div>
        ...
        <div class="sub-cont" style="background-color: #2b2b2b">
            ...
            <div class="form sign-up" style="background: #000">
                <form action="<?= base_url('user/daftar') ?>" method="post">
                    ...
                    <input type="submit" class="submit" value="DAFTAR" style="margin-left: 250px;"></input>
                </form>
                <?= validation_errors(); ?>
    ...
    <script type="text/javascript" src="<?= base_url('assets/js/script-login.js') ?>"></script>
</body>
